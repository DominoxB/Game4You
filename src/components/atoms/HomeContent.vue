<template>
  <div>
    <div class="flex items-center justify-center py-16 lg:py-10 md:pt-16 text-white">
      <span
        class="relative w-[max-content] font-silk text-xl sm:text-2xl uppercase md:text-3xl lg:text-5xl before:absolute before:inset-0 before:animate-typewriter before:bg-gray-900 after:absolute after:inset-0 after:w-[0.125em] after:animate-caret after:bg-white">
        grasz z nami???
    </span>
    </div>
